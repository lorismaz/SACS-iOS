//
//  SACSGenericRestPostCaller.swift
//  DevEssentials
//
...
class SACSGenericRestPostCaller<RQType: Mappable, RSType: Mappable>: SACSGenericRestCaller<RSType> {
    var request: RQType?
    ...
    override func doCallWithToken(accessToken: String, tokenType: String, completionHandler: (request: NSURLRequest?, response: RSType?, json: [String : AnyObject]?) -> ()) {
        ...
        if let request = request {parameters = Mapper().toJSON(request)}
